...
from src.services.vector_service import VECTOR_STORE_DIR, HASH_MAPPING_FILE
from src.services.model_service import get_embedding_model, get_llm_model
import shutil

distance_strategy=DistanceStrategy.MAX_INNER_PRODUCT
embeddings_model =get_embedding_model()
gpt4_o = get_llm_model()
